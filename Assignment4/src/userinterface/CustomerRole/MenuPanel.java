...
public class MenuPanel extends javax.swing.JPanel {
        ...
        tablemodel.setRowCount(0);
         ...
         Object[] row = new Object[3];
                for(Dishes dish:items){
                     ...
                     row[1] = dish.getDescription();
                     row[2] = dish.getPriceofDish();
                     sum=sum+Integer.parseInt(dish.getPriceofDish());
                     tablemodel.addRow(row);
                }
    }
    ...
    private void btnOrderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOrderActionPerformed
        ...
        restaurant.addingOrder(restaurant.getName(), userAccount.getUsername(), null, items, String.valueOf(sum) , address);
        for(Customer cust:ecosystem.getCustomerDirectory().getCustomerDirectory()){
            if(userAccount.getUsername().equals(cust.getUsername())){
                cust.addingOrder(restaurant.getName(), userAccount.getUsername(), null, items, String.valueOf(sum) , address);
